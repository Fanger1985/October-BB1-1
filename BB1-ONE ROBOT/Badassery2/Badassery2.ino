    ...
    if (currentMillis - stepStartTime >= interval) {
        switch (step) {
            ...
            case 9:
                ...
                break;
            case 10:
                // Quickly move ears to right 14, left 23
                if (!isEarMoving) {
                    targetRightEarAngle = 14;
                    targetLeftEarAngle = 23;
                    isEarMoving = true;
                    stepStartTime = currentMillis;
                    step++;
                }
                break;
            case 11:
                // Move ears to right 102, left 126
                if (!isEarMoving) {
                    targetRightEarAngle = 102;
                    targetLeftEarAngle = 126;
                    isEarMoving = true;
                    stepStartTime = currentMillis;
                    step++;
                }
                break;
            case 12:
                // Wiggle the right ear
                if (!isEarMoving) {
                    targetRightEarAngle = 90; // Move right ear slightly
                    isEarMoving = true;
                    stepStartTime = currentMillis;
                    step++;
                }
            ...
            case 13:
                if (!isEarMoving) {
                    targetRightEarAngle = 102; // Return right ear to 102
                    isEarMoving = true;
                    stepStartTime = currentMillis;
                    step++;
                }
                break;
            case 14:
                // Finish with right ear at 102 and left ear at 126
                if (!isEarMoving) {
