...
void startDemo1() {
    if (isDemo1Running || isDemo2Running || isNodYesRunning || isShakeNoRunning) return; // Do not start if another demo is running
    isDemo1Running = true;
    demo1Millis = millis();
}
...
void startNodYes() {
    if (isDemo1Running || isDemo2Running || isNodYesRunning || isShakeNoRunning) return; // Do not start if another animation is running
